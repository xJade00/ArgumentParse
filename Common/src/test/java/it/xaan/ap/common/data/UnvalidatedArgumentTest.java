...
public class UnvalidatedArgumentTest {
  private static final UnvalidatedArgument first = new UnvalidatedArgument("name", "value");
  private static final UnvalidatedArgument second = new UnvalidatedArgument("name", "value");
  private static final UnvalidatedArgument third =
      new UnvalidatedArgument("name", "different value");
